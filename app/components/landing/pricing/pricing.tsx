import languageInterface, {
  Language,
} from "@/modules/client/languageInterface/language";
...
export default function Pricing({ lang }: { lang: Language }) {
  ...
  return (
    <section
      id="pricing"
      className="mb-10 mt-40 flex w-11/12 flex-col justify-evenly gap-10 rounded-2xl bg-background_gray p-4 md:flex-row md:p-20"
    >
