...
import { ListInterface, ParagraphInterface, useEditor } from '../../context/editorContext'
import { v4 } from 'uuid'
...
export default function ListItem({
    ...
    const handleEnterKey = (e: React.KeyboardEvent<HTMLDivElement>) => {
        ...
        const newData = [...data]
        const id = v4()
        const newBlock: ListInterface = item
    ...
    return (
        <div className="flex gap-2">
            ...
            <Contenteditable
                ...
                className="w-full text-lg opacity-70 focus:outline-none"
